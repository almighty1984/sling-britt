...
namespace entity {
    void Frog::state_heal(cF32 dt) {
        ...
        //console::log(class_name(), "::state_heal() health: ", health_amount(), " ", m_time_left_until_next_state, "\n");
        ...
        if (m_time_left_until_next_state == 0 or health::is_max(m_health_id) or is_hurting()) {
