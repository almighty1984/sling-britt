...
export namespace entity {
    class Lever : public Object {
        ...
        void flip_it() {
            if (m_time_left_dead == 0) {
                ...
                anim::source_x(anim("dead"), 0);
                anim::speed(anim("dead"), 0.5F);
            } else {
                m_time_left_dead = 0;
                anim::source_x(anim("idle"), 0);
    ...
    public:        
        ...
        void update() override {
            ...
            //if (anim::source(m_current_anim).x ==
            //        (anim::source(m_current_anim).w * anim::texture_w(m_current_anim) / anim::source(m_current_anim).w)
