...
namespace entity {
    void Mole::collide_x(aabb::cInfo our, aabb::cInfo other) {
        ...
        if (m_state == state::Type::swim) {
            switch (other_type) {
                ...
                case Type::clip_ledge_R_50: {
                    ...
                    } else if ((our_velocity.x < 0.0F and (other_type == Type::clip_R or
                                                           other_type == Type::clip_R_50 or
                                                           other_type == Type::clip_ledge_R_50))
                        or other_type == Type::clip_ledge) {
        ...
        else if (m_state == state::Type::dive) {
            if (our_velocity.x < 0.0F and (other_type == Type::clip_R or
