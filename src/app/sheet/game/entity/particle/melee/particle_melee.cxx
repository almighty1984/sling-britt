...
namespace entity {
    ...
    void ParticleMelee::collide_x(aabb::cInfo our, aabb::cInfo other) {
        ...
        if (other_type == Type::clip or other_type == Type::clip_ledge) {
            ...
            particle::spawn(this,
                            particle::Type::hit,
                            { our_points.x + our_extent.x / 2.0F - 8.0F,
                              our_points.y + our_extent.y / 2.0F - 8.0F },
                            {});
        }        
            ...
            if (m_parent->type() == Type::player) {
                ...
                //cVec2F rect_size = { other_points.w - other_points.x, other_points.h - other_points.y };
                //m_parent->sling_level_offset = Vec2F{ other_points.x, other_points.y } + camera::position - rect_size / 2;
