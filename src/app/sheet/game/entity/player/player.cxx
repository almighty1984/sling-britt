...
namespace entity {
    Player::Player() {
        ...
        sprite::transform(m_sling_shot_sprite, m_transform);

        m_sling_shot_bg_sprite = sprite::make("res/texture/sling_shot_bg.png");
        sprite::rect(m_sling_shot_bg_sprite, sprite::rect(m_sling_shot_sprite));
        sprite::origin(m_sling_shot_bg_sprite, sprite::origin(m_sling_shot_sprite));
