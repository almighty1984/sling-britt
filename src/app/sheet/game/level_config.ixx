...
public:
    ...
    static void load(const std::filesystem::path& path) {
        ...
        console::log("sheet::Game::load_level_config: ", level_name, "\n");

        std::ifstream in_file("res/levels.cfg");
        if (!in_file) {
            console::error("sheet::Game::load_level_config levels.cfg not found!\n");
            return;
        }
        ...
        while (text.at(level_open) != '{') {
            ...
            if (level_name_start == std::string::npos) {
                console::error("sheet::Game::load_level_config ", level_name, " not found!\n");
                return;
            }
        ...
        if (level_close != std::string::npos) {
            ...
            if (L_0_label < level_close) {
                ...
                if (L_0_start < end_line) {
                    ...
                    console::log("sheet::Game::load_level_config L_0: ", m_level_path_L_0, "\n");
                }
            }
            ...
            if (R_0_label < level_close) {
                ...
                if (R_0_start < end_line) {
                    ...
                    console::log("sheet::Game::load_level_config R_0: ", m_level_path_R_0, "\n");
                }
            }
            ...
            if (music_label < level_close) {
                ...
                if (music_start < end_line) {
                    ...
                    console::log("sheet::Game::load_level_config music path: ", m_level_music_path, " prev: ", m_prev_level_music_path, "\n");
            ...
            if (trigger_label < level_close) {
                ...
                if (value_start < end_line) {
                    ...
                    console::log("sheet::Game::load_level_config m_trigger_paths[0]: ", m_trigger_paths.at(number), "\n");
                }
            }*/
        }
    }
