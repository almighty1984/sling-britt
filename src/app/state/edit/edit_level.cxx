...
namespace state {
    ...
    void Edit::undo_last_act() {
        ...
        if (!m_undo_acts.empty()) {
            console::log("state::Edit::undo_last_act() next: ", history::to_string(m_undo_acts.back()), "\n");            
        } else {
    ...
    void Edit::redo_last_act() {
        ...
        console::log("state::Edit::redo_last_act: ", history::to_string(m_redo_acts.back()), " count: ", m_redo_counts.back(), "\n");
        ...
        if (!m_redo_acts.empty()) {
            console::log("state::Edit::redo_last_act() next: ", history::to_string(m_redo_acts.back()), "\n");            
        } else {
