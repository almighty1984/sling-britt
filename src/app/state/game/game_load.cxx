...
namespace sheet {
    ...
    void Game::load_level(const std::filesystem::path& path) {
                ...
                if (types_map.count(tile_number)) {
                    ...
                    if (entity_type != entity::Type::none) {                        
                        ...
                        if (entity_type == entity::Type::brick) {
                            ...
                            console::log("state::Game::load_level() found bridge: ", (int)i.layer, " ", tile_offset.x, " ", tile_offset.y, "\n\n");
        ...
        console::log("state::Game::load_level() highest quad tree node: ", highest_quad_tree_node.x, " ", highest_quad_tree_node.y, "\n");
        ...
        console::log("\n\nstate::Game::load_level() start position: ", m_start_position.x, " ", m_start_position.y, " layer: ", (I32)m_player.start_layer(), "\n\n");
    }
}