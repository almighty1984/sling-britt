...
export namespace sound {
    ...
    public:
        ...
        bool sound_is_looped(const std::string& s)                { return sound::is_looped(sound_id(s));   } void sound_is_looped(const std::string& s, bool q) { sound::is_looped(sound_id(s), q); }
        bool sound_is_paused(const std::string& s)                { return sound::is_paused(sound_id(s));   }
        bool sound_is_playing(const std::string& s)               { return sound::is_playing(sound_id(s));  }
        bool sound_is_stopped(const std::string& s)               { return sound::is_stopped(sound_id(s));  }
    };
